...
All Claude Code configuration is managed in `~/code/dotfiles/claude/` and symlinked to their active locations:

- **User settings**: `~/code/dotfiles/claude/user/settings.json` -> `~/.claude/settings.json`
- **Project settings**: `~/code/dotfiles/claude/project/<name>/settings.local.json` -> `<project>/.claude/settings.local.json`

Steps:
1. Read the user settings file at `~/code/dotfiles/claude/user/settings.json`
